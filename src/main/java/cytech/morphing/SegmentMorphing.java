...
public class SegmentMorphing
{
	...
	/**
     	* Constructeur de SegmentMorphing
	...
	* @param b : double, réel positif qui croît avec l'impact de la distance depuis un pixel vers un segment sur la transformation occasionnée sur ce pixel
 	* @param p : double, réel positif qui croît avec l'impact de la longueur des segments sur l'intensité des déformations occasionnées
   	*/	
	public SegmentMorphing(Segment[] src, Segment[] dest, double a, double b, double p)
	{
	...
	/**
     	* Constructeur de SegmentMorphing, ici par défaut, des valeur sont associées automatiquement à a,b et p
    	* @param src : segments définis sur l'image source
     	* @param dest : segments définis sur l'image de destination
   	*/	
	public SegmentMorphing(Segment[] src, Segment[] dest)
	{
		this(src,dest,100,1.5,0.6);
	}
	...
	*/	
	...
	/**
   	* Methode qui modifie l'ImageView inter de sorte que cela réprésente l'étape coeff du morphing de src vers dest, selon les paramètres de l'objet SegmentMorphing présent
